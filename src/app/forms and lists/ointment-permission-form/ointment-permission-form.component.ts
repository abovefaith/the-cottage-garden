...
@Component({
  selector: 'app-ointment-permission-form',
  templateUrl: './ointment-permission-form.component.html',
  styleUrls: ['./ointment-permission-form.component.scss']
})
export class OintmentPermissionFormComponent implements OnInit {
