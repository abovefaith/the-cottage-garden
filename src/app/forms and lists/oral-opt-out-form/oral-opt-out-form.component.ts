...
@Component({
  selector: 'app-oral-opt-out-form',
  templateUrl: './oral-opt-out-form.component.html',
  styleUrls: ['./oral-opt-out-form.component.scss']
})
export class OralOptOutFormComponent implements OnInit {
