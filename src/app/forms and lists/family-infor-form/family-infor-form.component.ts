...
@Component({
  selector: 'app-family-infor-form',
  templateUrl: './family-infor-form.component.html',
  styleUrls: ['./family-infor-form.component.scss']
})
export class FamilyInforFormComponent  implements OnInit {
